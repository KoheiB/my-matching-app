      ...
      <v-card>
        ...
        <v-card-actions>
          <v-row class="text-center">
            <v-col cols="12"> メールアドレスでログイン </v-col>
            <v-col cols="12">
              <v-btn width="80%" @click="emailLogInDialog = !emailLogInDialog"
                >Email and Password</v-btn
              >
            </v-col>
            <v-col cols="12">
              <v-divider></v-divider>
            </v-col>
            <v-col cols="12"> SNSでログイン </v-col>
            <v-col cols="12">
            ...
            <v-col cols="12">
              <v-btn width="40%" @click="logInDialog = !logInDialog"
                >Cancel</v-btn
              >
            </v-col>
          </v-row>
        ...
        <v-card-actions>
          <v-form>
            <v-row class="text-center">
              ...
              <v-col cols="12">
                <v-btn @click="emailLogInDialog = !emailLogInDialog" width="30%"
                  >Cancel</v-btn
                >
              </v-col>
            </v-row>
